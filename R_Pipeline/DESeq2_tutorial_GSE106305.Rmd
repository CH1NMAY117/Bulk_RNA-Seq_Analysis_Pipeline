...
```{r}
getwd()
#setwd("C:\\Users\\caror\\Documents\\GSE106305")  # to have all results at this path
#I have used setwd during each chunk, as the directory sets to my default (~Documents\) after each run.
...
```{r}
annotation_file <- "C:/Users/caror/Documents/GSE106305/GRCh38annotation.csv"
annotation <- fread(annotation_file, stringsAsFactors = FALSE)
counts_gse <- read.csv("C:/Users/caror/Documents/GSE106305/GSE106305_counts_matrix.csv",
                     header = TRUE,
...
png("C:\\Users\\caror\\Documents\\GSE106305\\density_plots_raw_vst.png",
...
setwd("~/GSE106305")
library(fgsea)
hallmark_pathway <- gmtPathways("h.all.v7.1.symbols.gmt.txt")
